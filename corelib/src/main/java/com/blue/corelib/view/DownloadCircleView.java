...
import com.blue.corelib.utils.DisplayUtil;
...
public class DownloadCircleView extends View {
    ...
    public DownloadCircleView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
        outsideRadius = DisplayUtil.dip2px(context, 100);
        progressWidth = DisplayUtil.dip2px(context, 10);
        progressTextSize = DisplayUtil.dip2px(context, 10);
    }
    ...
    protected void onDraw(Canvas canvas) {
       ...
       // canvas.drawText(txt, (float) x1 - strwid / 2, (float) y1 + progressTextSize / 2 - progressWidth / 2, mTxtPaint);
        canvas.drawText(txt, (float) x1 - strwid / 4, (float) y1 + progressTextSize / 4 - progressWidth / 4, mTxtPaint);
