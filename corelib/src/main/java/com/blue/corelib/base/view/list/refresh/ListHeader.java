...
public class ListHeader extends InternalClassics<ListHeader> {
...
//    }
    ...
    public ListHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public ListHeader setTimeFormat(DateFormat format) {
    ...
    public ListHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public ListHeader setAccentColor(@ColorInt int accentColor) {
        mLastUpdateText.setTextColor(accentColor & 0x00ffffff | 0xcc000000);
        return super.setAccentColor(accentColor);
    }

    public ListHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
...
//            mRefreshKernel.requestRemeasureHeightForHeader();
    ...
    public ListHeader setTextSizeTime(float size) {
...
//    }
    ...
    public ListHeader setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
