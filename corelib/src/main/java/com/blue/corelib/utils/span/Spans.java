...
public class Spans {
    ...
    public static Span image(@NonNull final Drawable drawable, final int verticalAlignment) {
        return new Span(new SpanBuilder() {
            @Override
            public Object build() {
                return new VerticalImageSpan(drawable, verticalAlignment);
            }
        });
    }
    ...
    public static Span image(@NonNull final Context context, final Bitmap bitmap, final int verticalAlignment) {
        return new Span(new SpanBuilder() {
            @Override
            public Object build() {
                return new VerticalImageSpan(context, bitmap, verticalAlignment);
            }
        });
    }
     ...
     * @see ClickableSpan
     */
    public static Span click(@NonNull final View.OnClickListener onClickListener, @ColorInt int fixedColor) {
        return new Span(new ClickSpanBuilder(onClickListener)
                .color(fixedColor));
    }
    ...
    public static Span typeface(Typeface typeface) {
        return new Span(new TypefaceSpanBuilder(typeface));
    }
